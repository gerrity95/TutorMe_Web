    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            ...
            <ul class="nav navbar-nav navbar-right">
              <li class="active"><a href="register.php" class=""><span style="padding-right:10px" class="glyphicon glyphicon-user"></span>Register</a></li>
              <li class="dropdown">
...
<div class="jumbotron">
	...
	<div class="page-header">
        ...
        <p><a href="login.php" class="btn btn-success btn-lg">Login Here</a></p>
    </div>
</div>
